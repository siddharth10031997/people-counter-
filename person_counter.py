...
#     frame = image.array
    ...
    for cnt in contours0:
        ...
        if area > areaTH:
            ...
            # Missing conditions for multipersons, outputs and screen entries.              #noqa
    ...
    cv2.setWindowProperty(frame, cv2.WND_PROP_FULLSCREEN, cv2.cv.WINDOW_FULLSCREEN)
